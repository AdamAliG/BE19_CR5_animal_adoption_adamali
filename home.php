...
$sqlUsers = "SELECT * FROM user WHERE status != 'user'";
...
<?php
echo "<h1 class='text-center mt-5 text-light'> Welcome User </h1>
    <div class='container'>
    <div class='row justify-content-center'>";

if(mysqli_num_rows($resultAnimals) > 0){
    while ($animalRow = mysqli_fetch_assoc($resultAnimals)){
        $layout .= "<div class='col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-3'>
